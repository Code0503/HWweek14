package com.parabank.demo.customlisteners;
...
import static com.parabank.demo.utility.Utility.takeScreenShot;
...
//        Reporter.log("<a target = \"_blank\" href="+screenshotName+"><img src="+screenshotName+" height=200 width=200></img></a>");
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        reporter.config().setReportName("ParaBank"); // please change my name to current project name before you submit, else goo luck----
